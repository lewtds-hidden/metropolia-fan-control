...
src/%.o: ../src/%.cpp
	...
	arm-none-eabi-c++ -D__NEWLIB__ -DDEBUG -D__CODE_RED -DCORE_M3 -D__USE_LPCOPEN -DCPP_USE_HEAP -D__LPC15XX__ -I"C:\Users\krl\Documents\metropolia\kurssit\2016\k16_embedded_systems_programming\test\lpc_board_nxp_lpcxpresso_1549\inc" -I"C:\Users\krl\Documents\metropolia\kurssit\2016\k16_embedded_systems_programming\test\lpc_chip_15xx\inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fno-rtti -fno-exceptions -mcpu=cortex-m3 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
